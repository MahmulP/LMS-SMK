...
Route::middleware(['auth'])->group(function(){
    ...
    Route::middleware(['isGlobalAccess'])->group(function(){
        ...
        Route::middleware(['admin'])->group(function(){
            ...
            Route::get('/atur-website', [SettingController::class, 'setting'])->name('atur-website');
            Route::post('/atur-website', [SettingController::class, 'update'])->name('atur-website.update');
