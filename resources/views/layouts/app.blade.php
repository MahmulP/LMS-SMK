...
<head>
    ...
    <meta name="author" content="Machmul Pratama">
    <title>LMS PTIK ISBD</title>
...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static  " data-open="click"
            ...
            <ul class="nav navbar-nav align-items-center ms-auto">
                ...
                <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link"
                        ...
                        <div class="user-nav d-sm-flex d-none"><span
                                ...
                                class="user-status">@if ($user->role == 'WaliKelas')
                                    Wali Kelas
                                @else
                                    {{ $user->role }}
                                @endif</span></div><span
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item me-auto"><a class="navbar-brand" href="{{ route('dashboard') }}"><span
                            ...
                            <img src="{{ asset('logo/' . $setting->logo_sekolah) }}" alt="" srcset=""></span>
                        <h2 class="brand-text">{{$setting->singkatan_sekolah}}</h2>
                    </a></li>
        ...
        <div class="main-menu-content">
                    ...
                    <ul class="menu-content">
                        <li class="{{ request()->is('/*') ? 'active' : '' }}"><a class="d-flex align-items-center"
                                href="{{ route('home') }}"><i data-feather="circle"></i><span
                                    class="menu-item text-truncate" data-i18n="eCommerce">{{$setting->singkatan_sekolah}}</span></a></li>
                    </ul>
            ...
            @endif
            @if (Auth::user()->role == 'Admin' || Auth::user()->role == 'Guru' || Auth::user()->role == 'WaliKelas')
            ...
            @endif
            @if (Auth::user()->role == 'Admin' || Auth::user()->role == 'Guru' || Auth::user()->role == 'Siswa' || Auth::user()->role == 'WaliKelas')
                <li class=" nav-item"><a class="d-flex align-items-center mt-1" href="#"><i
                            data-feather="database"></i><span class="menu-title text-truncate" data-i18n="User">Data
                            Guru</span></a>
                    <ul class="menu-content">
            ...
            <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather="book"></i><span
                ...
                @if (Auth::user()->role == 'Admin')
                <li class=" navigation-header"><span data-i18n="User Interface">Website Management</span><i
                    data-feather="more-horizontal"></i>
                </li>
                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i
                            data-feather="settings"></i><span class="menu-title text-truncate" data-i18n="User">Atur Website</span></a>
                    <ul class="menu-content">
                        <li class="{{ request()->is('atur-website*') ? 'active' : '' }}"><a
                                class="d-flex align-items-center" href="{{ route('atur-website') }}"><i
                                    data-feather="circle"></i><span class="menu-item text-truncate"
                                    data-i18n="List">Data Sekolah</span></a>
                        </li>
                </li>
                </ul>
                </li>
    ...
    <div class="app-content content ">
        ...
        <div class="content-wrapper container-xxl p-0">
            ...
            <div class="content-body">
                ...
                <script src={{ asset('app-assets/vendors/js/toastr.js') }}></script>
                <!-- BEGIN Vendor JS-->
                ...
                <script>
                    ...
                    $(document).ready(function() {
                        $('.summernote').summernote({
                            height: 300,
                            disableHtmlResizing: false, // Make sure this option is set to false
                        });
                    });
